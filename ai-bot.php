                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row d-flex flex-row justify-content-center">
                                    <span class="display-1 text-black text-center rel lead">Coming Soon</span>
                                    <div class="col-12 col-md-6 order-2 order-md-1 mt-3 mt-md-0 text-center">
                                        <img src="bot.jpg" class="img-fluid" width="400px">
                                        <div class="col-12 shadow text-center p-3 mt-3 rounded-5">
                                            <span class="lead text-center">CODY AI - Chat Bot <span
                                                    class="badge text-bg-success">Beta</span>
                                            </span> <br>
                                            ...
                                            <br>
                                            <button class="btn btn-outline-warning">Upgrade To Premium</button>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row d-flex flex-row justify-content-center">
                                            <div class="col-8 shadow p-3 border position-relative">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <img src="../assets/logo-cody-bot.png" class="img-fluid w-100 h-100" alt="">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
